...
CREATE TABLE IF NOT EXISTS personal (
    ...
    rol TEXT NOT NULL CHECK(rol IN ('Administrador', 'Empleado', 'Cajero')),
...
CREATE TABLE IF NOT EXISTS productos (
    ...
    -- se calcula en la aplicacion comparando cantidad == 0, para evitar
    -- que quede desincronizado con el stock real.
...
-- static/uploads/importaciones y aqui queda el historial consultable.
-- -----------------------------------------------------
...
-- Personal semilla: Yeraldin es solo un cajero de ejemplo para los
-- selects de Ventas. El usuario "admin" es la cuenta inicial del
-- sistema (usuario: admin / contrasena: admin123); el administrador
-- real debe cambiar esa contrasena o crear su propia cuenta y
-- eliminar/desactivar esta desde la pantalla de Usuarios.
INSERT OR IGNORE INTO personal (id_personal, nombres, apellido_paterno, apellido_materno, ci, telefono, usuario, contrasena_hash, rol, estado) VALUES
    (1, 'Yeraldin', 'Quispe', 'Mamani', '1111111', '70000001', 'yeraldin', 'temporal', 'Cajero', 1),
    (2, 'Admin', 'Sistema', NULL, '0000000', '70000000', 'admin', 'temporal', 'Administrador', 1);
